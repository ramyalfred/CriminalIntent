...
public class DatePickerFragment extends DialogFragment {
    ...
    /*public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        return new AlertDialog.Builder(getActivity()).setView(v).setTitle(R.string.date_picker_title).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Log.d(getClass().getSimpleName(),"OK Button Pressed");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.dialog_date_full,container,false);

        mDatePicker = (DatePicker) v.findViewById(R.id.dialog_date_full_date_picker);
        mButton = (Button) v.findViewById(R.id.dialog_date_ok_button);
